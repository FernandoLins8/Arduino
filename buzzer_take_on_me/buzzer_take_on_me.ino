...
float duration[] = {EIGHTH, EIGHTH, EIGHTH, EIGHTH, EIGHTH, EIGHTH, 
...
int length; // numero de notas na melodia
byte buzzer = 11;
...
void setup()
{
  ...
  Serial.println(sizeof(tune)/sizeof(int));
  Serial.println(sizeof(duration)/sizeof(float));
  pinMode(buzzer, OUTPUT);
  length = sizeof(tune) / sizeof(tune[0]); // sizeof retorna o número de bytes
}
